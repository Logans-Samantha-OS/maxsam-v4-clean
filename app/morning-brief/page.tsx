    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0a] to-[#111] p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">{brief?.date}</h1>
        ...
        <div className="bg-gradient-to-r from-green-500/10 to-cyan-500/10 border border-green-500/30 rounded-xl p-6 mb-8">
          <div className="flex justify-between items-center">
            ...
            <div className="text-right">
              <div className="text-zinc-400 text-sm">Estimated Revenue</div>
              <div className="text-3xl font-bold text-cyan-400">{formatCurrency(brief?.summary.estimated_revenue || 0)}</div>
            </div>
          </div>
        </div>
